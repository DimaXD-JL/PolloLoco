const level1 = new Level(
    ...
    [
     ...
     [
        ...
        new BackgroundObject('img_pollo_locco/img/5_background/layers/air.png',1438),
        new BackgroundObject('img_pollo_locco/img/5_background/layers/3_third_layer/1.png',1438),
        new BackgroundObject('img_pollo_locco/img/5_background/layers/2_second_layer/1.png',1438),
        new BackgroundObject('img_pollo_locco/img/5_background/layers/1_first_layer/1.png',1438),
        
        new BackgroundObject('img_pollo_locco/img/5_background/layers/air.png',2157 ),
        new BackgroundObject('img_pollo_locco/img/5_background/layers/3_third_layer/2.png',2157 ),
        new BackgroundObject('img_pollo_locco/img/5_background/layers/2_second_layer/2.png',2157 ),
