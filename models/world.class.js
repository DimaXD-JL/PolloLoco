class World{
    ...
    draw() {
        this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);// mit dem CODE vermeide ich die doppeltwerzeugung der Objekte im Canvas 
        // die reihnefolger der Objekte die eingefügt werden ist wichtig!!
